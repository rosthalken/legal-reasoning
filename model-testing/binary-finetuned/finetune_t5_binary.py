...
output_path = os.path.join(formalism_dir, 'results', 't5-base_binary')
...
for split in range(0, 5):
    ...
    sample_dict = {
        "model": "t5_base_finetuned_binary",
        "split": split,
...
full_df.to_csv(os.path.join(output_path, 't5_base_binary_results.csv'))
